...
public class ServicoDeAluguel {
	...
	private ServicoImpostosBrasil servicoImpostosBrasil;
	
	//Construtor com argumentos
	public ServicoDeAluguel(Double precoPorHora, Double precoPorDia, ServicoImpostosBrasil servicoImpostosBrasil) {
		this.precoPorHora = precoPorHora;
		this.precoPorDia = precoPorDia;
		this.servicoImpostosBrasil = servicoImpostosBrasil;
	}
	...
	public void processarNotaFiscal(AluguelDeCarro aluguelDeCarro) {
		...
		double imposto = servicoImpostosBrasil.totalImposto(pagamentoBasico);
